...
- Расширенный режим: в плавающее окно переезжает плеер с полосой перемотки,
  громкостью, выбором звуковой дорожки и субтитров. Скорость, повтор
  и автопереход задаются до открытия окна. Очередь, настройки и полный экран
  остаются в основном окне.
  - Горячие клавиши работают и в плавающем окне.
  - Рекомендуемая минимальная ширина окна: 300 пикселей. Уже этого кнопки
...
- Общие настройки плеера под шестерёнкой справа вверху: панель файлов
  ...
  видео), ручное изменение порядка файлов, скрытие панели управления при
  автопереходе, шрифт, язык. Там же список горячих клавиш и кэш сервера.
